...
proc vTclWindow.top1 {base} {
    ...
    wm geometry $top 1360x737+315+114
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
...
set site_3_0 $top.mem50
    $top.mem50 add cascade \
        -menu "$top.mem50.men47" -font "-family {DejaVu Sans} -size 10" -image dialog_question_png \
        -label "?" 
    menu "$site_3_0.men47" \
        -activebackground #d9d9d9 -activeforeground black \
        -font "-family {DejaVu Sans} -size 10" -tearoff 0 
    $top.mem50 add command \
        -command "#" -font "-family {DejaVu Sans} -size 10" \
        -image help_about_png -label "A" 
    $top.mem50 add command \
        -command "#on_TBtnExit" -font "-family {DejaVu Sans} -size 10" \
        -image window_close_png -label "X" 
    ttk::frame "$top.tFr50" \
        -borderwidth 2 -relief flat -width 1335 -height 665 
    vTcl:DefineAlias "$top.tFr50" "TFrameSplash" vTcl:WidgetProc "Toplevel1" 1
    ...
    vTcl:DefineAlias "$site_4_0.scr47" "Scrolledtext2" vTcl:WidgetProc "Toplevel1" 1

    $site_4_0.scr47.01 configure -background cornsilk4 \
        -borderwidth 2 \
        -font TkTextFont \
        -foreground black \
        -height 3 \
    ...
    place $site_4_0.scr47 \
        -in $site_4_0 -x 230 -y 18 -width 914 -relwidth 0 -height 545 \
        -relheight 0 -anchor nw -bordermode ignore 
    ...
    vTcl:DefineAlias "$site_3_0.tRa48" "TRadiobutton1" vTcl:WidgetProc "Toplevel1" 1
    bind $site_3_0.tRa48 <<SetBalloon>> {
        set ::vTcl::balloon::%W {Choose your language}
    }
    vTcl:copy_lock $site_3_0.tRa48
    ttk::radiobutton "$site_3_0.tRa49" \
        -variable "selectedButton" -command "on_Rbtn" -image no_png \
        -compound left 
    vTcl:DefineAlias "$site_3_0.tRa49" "TRadiobutton2" vTcl:WidgetProc "Toplevel1" 1
    bind $site_3_0.tRa49 <<SetBalloon>> {
        set ::vTcl::balloon::%W {Choose your language}
    }
    vTcl:copy_lock $site_3_0.tRa49
    ...
    bind $site_3_0.tBu53 <<SetBalloon>> {
        set ::vTcl::balloon::%W {Are you ready to start?}
    }
    vTcl:copy_lock $site_3_0.tBu53
    place $site_3_0.tRa48 \
        -in $site_3_0 -x 10 -y 15 -width 57 -relwidth 0 -height 27 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.tRa49 \
        -in $site_3_0 -x 75 -y 15 -width 50 -relwidth 0 -height 23 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.tBu53 \
        -in $site_3_0 -x 145 -y 10 -width 74 -relwidth 0 -height 35 \
        -relheight 0 -anchor nw -bordermode ignore 
    ...
    ttk::label "$site_3_0.tLa49" \
        ...
        -justify left \
        -text "Dette er en forklaring til bildet over her.  Men dette er bare for å syne lengd" \
        -compound left 
    vTcl:DefineAlias "$site_3_0.tLa49" "TLblExplanation" vTcl:WidgetProc "Toplevel1" 1
    ...
    ###################
    place $top.tFr50 \
        -in $top -x 10 -y 10 -width 1338 -relwidth 0 -height 665 -relheight 0 \
        -anchor nw -bordermode ignore 
    place $top.tFr53 \
        -in $top -x 19 -y 23 -width 642 -relwidth 0 -height 641 -relheight 0 \
        -anchor nw -bordermode ignore 
    place $top.tFr48 \
        -in $top -x 10 -y 10 -width 664 -relwidth 0 -height 664 -relheight 0 \
        -anchor nw -bordermode ignore 
    place $top.fra47 \
        -in $top -x 527 -y 676 -width 235 -relwidth 0 -height 55 -relheight 0 \
        -anchor nw -bordermode ignore 
    place $top.tFr47 \
